...
\begin{figure}
  \centering
  \includegraphics[width=0.45\textwidth]{images/singularities.pdf}
  \hfill
  \includegraphics[width=0.45\textwidth]{images/singularities2.pdf}
  \caption{Singularities around a 5-sided and an 8-sided domain.}
  \label{fig:singularities}
\end{figure}

We present a solution to this problem. Normally the multi-sided domain is inside the unit
square (Figure~\ref{fig:domain}), so that the trimming curves will be inside the
...
An example with an 8-sided patch is shown in Figure~\ref{fig:8sided}.
\begin{figure}
