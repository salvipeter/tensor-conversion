...
\emph{adjoint curve} of the domain~\cite{Floater:2015}.
...
Practically this means that excluding the triangular
...
\begin{figure}[!ht]
  ...
  \hfill
  \begin{subfigure}{.24\textwidth}
    \includegraphics[width=\textwidth]{images/rotations/10.png}
    \caption{$\phi=10^\circ$}
  \end{subfigure}
  \hfill
  \begin{subfigure}{.24\textwidth}
  ...
  \hfill
  \begin{subfigure}{.24\textwidth}
    \includegraphics[width=\textwidth]{images/rotations/30.png}
    \caption{$\phi=30^\circ$}
  \end{subfigure}
  ...
  \hfill
  \begin{subfigure}{.24\textwidth}
    \includegraphics[width=\textwidth]{images/rotations/50.png}
    \caption{$\phi=50^\circ$}
  \end{subfigure}
  \hfill
  \begin{subfigure}{.24\textwidth}
  ...
  \hfill
  \begin{subfigure}{.24\textwidth}
    \includegraphics[width=\textwidth]{images/rotations/70.png}
    \caption{$\phi=70^\circ$}
  \end{subfigure}

  \begin{subfigure}{.48\textwidth}
    \centering
    \includegraphics[width=.5\textwidth]{images/rotations/75-optimal.png}
    \caption{$\phi\approx 75^\circ$ (optimal)}
  \end{subfigure}
  \hfill
  \begin{subfigure}{.48\textwidth}
    \centering
    \includegraphics[width=.5\textwidth]{images/rotations/80.png}
    \caption{$\phi=80^\circ$}
  \end{subfigure}
...
is not enough to deal with 7- or 8-sided surfaces.
...
essentially selecting the most flat control structure.
