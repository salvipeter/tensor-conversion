...
The majority of aesthetic objects is represented by free-form shapes, and modelling these
...
patch, and trimming -- in general -- cannot ensure even $C^0$ continuity between the
...
An example of four watertight trimmed patches with mean curvature and isophote lines is shown below.
\begin{figure}[h!]
...
all the other representations have \emph{singularities} in or outside their domains.
...
\begin{table}
  ...
  \begin{tabular}{c|c|c|c|c}
    ...
    3 & $d[+3]$ & $d[+3]$ & \cellcolor{light-gray}$3d+5$ & $d+3$ \\ \hline
