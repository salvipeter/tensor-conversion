...
\begin{table}
  ...
  \begin{tabular}{c|c|c|c|c}
    ...
    7+ & \cellcolor{light-gray}$nd-2d$ ($(n-2)d+3n-6$) & $\qquad$N/A$\qquad$ & \cellcolor{light-gray}$nd+2n-1$ & \cellcolor{light-gray}$nd+2n-4$ \\ \hline
  \end{tabular}
  \caption{Rational polynomial degrees of the converted surfaces for different number of sides,
    ...
    triangles. For S-patches, the number in parentheses shows the degree when the surface is
